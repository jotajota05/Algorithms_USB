...
public class Archivo {
	...
	/**Metodo para leer un grafo de un archivo de texto para el problema 1*/
	public void leerGrafoProblema1() throws IOException {
		...
		for(int j=0;j<numPruebas;j++) {
			...
			Problema1 P=new Problema1((DIGrafo)G);
			System.out.print("La suma de longitudes de lados, minima necesaria para conectar ");
			System.out.println("todos los vertices del grafo es: "+P.longitud()+"\n");
		}
	...
	/**Metodo para leer un grafo de un archivo de texto para el problema 2*/
